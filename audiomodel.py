...
class AudioProcessing(nn.Module):
    ...
    def inference(self, descriptions, compression_model, duration=None):
        if not duration:
        ...
        with torch.no_grad():
            ...
            gen_tokens, gen_audio = self.audio_generate(attributes, gen_duration=duration, compression_model=compression_model)
