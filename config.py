...
class Config:
    ...
    def update_train_config(self):
        ...
        self.num_warmup_steps = 5000
        self.max_train_steps = None
        self.device = 'cuda' 
        self.output_dir = "./ou_finetune_long"
        self.generated_dir = './gen_finetune_long'
        self.save_path = './gen_finetune_long'
        self.checkpointing_steps = "best"
        self.save_steps = 20
        self.resume_from_checkpoint = "./output_dir_finetune_no_tag/0_11.pth"
        self.resume_epoch = 0 
